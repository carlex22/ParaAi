...
### O Grande Objetivo: O Modelo `ParaAI`

O coração deste projeto é a criação do **`ParaAI`**, um modelo de linguagem treinado a partir de mais de **7 milhões de acórdãos** do Tribunal de Justiça do Paraná (TJPR).
